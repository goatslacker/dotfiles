gconftool-2 --set "/apps/gnome-terminal/profiles/Default/cursor_shape" \
...
gconftool-2 --set "/apps/gnome-terminal/profiles/Default/scroll_on_output" \
--type bool false
...
gconftool-2 --set "/apps/gnome-terminal/profiles/Default/pallete" \
--type string "#2E2E34343636:#CCCC00000000:#4E4E9A9A0606:#C4C4A0A00000:#34346565A4A4:#757550507B7B:#060698209A9A:#D3D3D7D7CFCF:#555557575353:#EFEF29292929:#8A8AE2E23434:#FCFCE9E94F4F:#72729F9FCFCF:#ADAD7F7FA8A8:#3434E2E2E2E2:#EEEEEEEEECEC"

gconftool-2 --set "/apps/gnome-terminal/profiles/Default/background_color" \
--type string "#202020202020"
...
gconftool-2 --set "/apps/gnome-terminal/keybindings/prev_tab" \
--type string "<Shift>Left"

gconftool-2 --set "/apps/gnome-terminal/keybindings/next_tab" \
--type string "<Shift>Right"
